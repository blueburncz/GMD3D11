...
assert(d3d11_structured_buffer_exists(bufferIn), "Could not create bufferIn!");
...
assert(d3d11_compute_buffer_exists(bufferOut), "Could not create bufferOut!");

uav = d3d11_compute_buffer_create_uav(bufferOut);
assert(d3d11_uav_exists(uav), "Could not create UAV!");

stagingBuffer = d3d11_readback_buffer_create(d3d11_sizeof(D3D11_FLOAT), _numElements);
assert(d3d11_readback_buffer_exists(stagingBuffer), "Could not create stagingBuffer!");
